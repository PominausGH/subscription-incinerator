        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            offers: [
              ...
              { '@type': 'Offer', price: '9', priceCurrency: 'USD', name: 'Premium' },
            ],
            description:
              'Track and cancel forgotten subscriptions. Automatically finds trials and recurring charges, then reminds you before you get charged.',
