...
export const DETECTION_RULES: DetectionRule[] = [
  {
    ...
    priceExtractor: /(?:\$|USD\s*|€|EUR\s*|£|GBP\s*|A\$|AUD\s*|C\$|CAD\s*|NZ\$|NZD\s*|¥|JPY\s*|CHF\s*)(\d+\.?\d{0,2})\s*(?:\/month|per month|monthly)/i,
  ...
  },
  {
    ...
    trialIndicators: ['free trial', 'trial period'],
    priceExtractor: /(?:\$|USD\s*|€|EUR\s*|£|GBP\s*|A\$|AUD\s*|C\$|CAD\s*|NZ\$|NZD\s*|¥|JPY\s*|CHF\s*)(\d+\.?\d{0,2})\s*(?:\/month|per month|monthly|\/year|per year)/i,
    dateExtractor: /(?:on|starting)\s+(\w+\s+\d{1,2},?\s+\d{4})/i,
    currencyExtractor: /(\$|USD|€|EUR|£|GBP|AUD|CAD|NZD|JPY|CHF|A\$|C\$|NZ\$|¥)/i,
  },
  {
