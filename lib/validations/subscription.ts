...
export const createSubscriptionSchema = z.object({
  ...
  billingCycle: z.enum(['weekly', 'fortnightly', 'monthly', 'bimonthly', 'quarterly', 'semi-annual', 'yearly', 'custom']).optional(),
...
export const updateSubscriptionSchema = z.object({
  ...
  billingCycle: z.enum(['weekly', 'fortnightly', 'monthly', 'bimonthly', 'quarterly', 'semi-annual', 'yearly', 'custom']).optional().nullable(),
